(function () {
    ...
    const DEFAULT_JUDGE_RULES_PROMPT = [
        ...
        '',
        '五、另一条不是这一段完成',
        '15. 分岔、支线、换到另一条，都是人来选的。正文碰到另一条上的事，不能当成这一段已经演完。',
        '16. YES 只表示这一条该走进自己的下一段。不要因为故事像另一条，或像可以回这条、去那边，就写 YES。',
    ].join('\n');
    ...
    const DEFAULT_JUDGE_ASSISTANT_PROMPT = [
        ...
        '8. 另一条上的事不算这一段完成。分岔、支线和换边由人来选，我不因此写 YES。',
    ].join('\n');
