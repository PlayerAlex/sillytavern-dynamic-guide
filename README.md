...
7. 在右侧提示词原文中拖选属于这一阶段的文字，点击“分配给当前阶段”。同一阶段可以选多处不连续文字。
8. 不想分阶段、但每次都要发给 AI 的内容，拖选后点击“设为常驻提示”。
...
```js
import 'https://gcore.jsdelivr.net/gh/PlayerAlex/sillytavern-dynamic-guide@v1.3.0/index.js';
```
